...
const TESTIMONIALS = [
  {
    src: testimonialSpiegelSrc,
        quote:
      "Students often make silly mistakes on their resume by using inconsistent bullet points or font sizes. ChatFolio’s auto format feature is a great help to ensure consistent format.",
    name: "Ms. Spiegel",
    title: "Educator",
  },
  {
    src: testimonialSantiSrc,
        quote:
      "I used ChatFolio during my last job search and was invited to interview at top tech companies such as Google and Amazon thanks to its slick yet professional resume design.",
    name: "Santi",
  ...
  },
  {
    src: testimonialVivianSrc,
        quote:
      "Creating a professional resume on ChatFolio is so smooth and easy! It saves me so much time and headache to not deal with google doc template.",
    name: "Vivian",
...
export const Testimonials = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    <section className="mx-auto -mt-2 px-8 pb-24">
        <h2 className="mb-8 text-center text-3xl font-bold text-primary-fg">
        People{" "}
        ...
        <div className="relative lg:ml-[-50px]">
          {TESTIMONIALS.map(({ src, quote, name, title }, idx) => {
            ...
            return (
              ...
              >
                                <figure className="m-1 flex gap-5 rounded-3xl bg-card border border-border-color p-5 text-primary-fg lg:p-7">
                  <Image
                  ...
                  <div>
                    ...
                    <figcaption className="mt-3">
                      <div className="hidden gap-2 lg:flex">
                        ...
                        <div
                          className="select-none text-secondary-fg"
                          aria-hidden="true"
                        >
                          •
                        </div>
                        <div className="text-tertiary-fg">{title}</div>
                      </div>
