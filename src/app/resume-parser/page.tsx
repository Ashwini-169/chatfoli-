...
const RESUME_EXAMPLES = [
  ...
  {
    fileUrl: "resume-example/chatfolio-resume.pdf",
    description: (
      <span>
        Created with ChatFolio resume builder -{" "}
...
// NOTE: Parser playground is currently disabled in the frontend navigation.
// This page remains for internal testing and can be re-enabled later.
  ...
  return (
    <main className="h-full w-full overflow-hidden">
      <div className="grid md:grid-cols-6">
        ...
        <div className="flex px-6 text-primary-fg md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          <FlexboxSpacer maxWidth={45} className="hidden md:block" />
          <section className="max-w-[600px] grow">
            ...
            <Paragraph smallMarginTop={true}>
              This playground showcases the ChatFolio resume parser and its
            ...
            <div className="mt-3 flex gap-3">
              {RESUME_EXAMPLES.map((example, idx) => (
                <article
                  key={idx}
                  className={cx(
                    "flex-1 cursor-pointer rounded-md border-2 px-4 py-3 shadow-sm outline-none hover:bg-card focus:bg-card bg-card",
                  ...
                  tabIndex={0}
                >
                  <h1 className="font-semibold text-primary-fg">Resume Example {idx + 1}</h1>
