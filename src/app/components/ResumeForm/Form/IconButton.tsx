...
export const ShowIconButton = ({
  ...
  <Icon className="h-6 w-6 text-tertiary-fg" aria-hidden="true" />
...
export const MoveIconButton = ({
  ...
  return (
    <IconButton
      ...
      size={size}
    >
  <Icon className={`${sizeClassName} text-tertiary-fg`} aria-hidden="true" />
      <span className="sr-only">{tooltipText}</span>
    </IconButton>
  );
};
...
export const DeleteIconButton = ({
  ...
  <TrashIcon className="h-4 w-4 text-tertiary-fg" aria-hidden="true" />
      <span className="sr-only">{tooltipText}</span>
    </IconButton>
  );
};
