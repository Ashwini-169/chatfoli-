...
export const InputGroupWrapper = ({
  ...
  <label className={`text-base font-medium text-primary-fg ${className}`}>
    {label}
    {children}
  </label>
);
...
export const INPUT_CLASS_NAME =
  "mt-1 px-3 py-2 block w-full rounded-md border bg-input text-primary-fg shadow-sm outline-none font-normal text-base";
